...
## How to use
I have supplied a project for Visual Studio, since i found it finicky to setup C++/CLI from scratch. If you know how to setup for C++/CLI, I am sure you know how to include libraries.
